courses = [
  {
    ...
    description:
      "Lorem Ipsn gravida nibh vel velit auctor aliquet.Aenean soll",
    price: "free",
    buttonName: "Software",
  },
   {
...
function renderGridView() {
  ...
  courses.forEach((course) => {
    ...
    courseDiv.innerHTML = `
        <div class="third-page-price-container" style="margin: 145px 0 0 220px; width="200px"><span>${course.price}</span></div>
        <img src=${course.image} alt="3rdPage-image" width="100%" height="40%">
        <div class="third-page-mini-container">
            <div style="margin: 20px 20px 0px 33px">
